...
#
# Builds the React front end (shop + admin) and serves it from nginx, which also
# proxies the API.
...
COPY deploy/docker/frontend.nginx.conf.template /etc/nginx/templates/default.conf.template
